function varargout = CMSD(varargin)
% CMSD MATLAB code for CMSD.fig
%      CMSD, by itself, creates a new CMSD or raises the existing
%      singleton*.
%
%      H = CMSD returns the handle to a new CMSD or the handle to
%      the existing singleton*.
% 
%      CMSD('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CMSD.M with the given input arguments.
%
%      CMSD('Property','Value',...) creates a new CMSD or raises the
...
% Edit the above text to modify the response to help CMSD

% Last Modified by GUIDE v2.5 29-Oct-2021 14:10:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CMSD_OpeningFcn, ...
                   'gui_OutputFcn',  @CMSD_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CMSD is made visible.
function CMSD_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = CMSD_OutputFcn(hObject, eventdata, handles) 
...
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
  ...
  % --- Executes on button press in segment_pbtn.

function segment_pbtn_Callback(hObject, eventdata, handles)
...
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
      ...
      [A] = pre_proce(B);
       ...
       imshow(BW2);
% --- Executes on button press in boundextr_pbtn.
function boundextr_pbtn_Callback(hObject, eventdata, handles)
% hObject    handle to boundextr_pbtn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    %Browse Input Image
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
...
Tvalue(:,1) =Trk;
Tvalue(:,2) =sec;
% set(t,'Data',Track); % Use the set command to change the uitable properties.
set( handles.uitable2, 'data', num2cell(Tvalue) )
% set(t,'ColumnName',{'a';'b';'c'})
% set(handles.uitable2,'Data',Track{1:4});
...
% --- Executes on button press in train_autotrain_btn.
function train_autotrain_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_autotrain_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
folder_name = uigetdir;

   str = input('Enter the cell category\n','s');
%    strn = str2double(str);
...
[cxx,cyy] = CCLabel(xx,yy,sectorcord,sector,nim,mx,R_y); % labelling circular mesh
[cxx,cyy] = embdimg(cxx,cyy);
[Trk,sec,secangle] = CMRepDes(cxx,cyy,R_x,R_y,rt,sector);
...
%% Convexity and Convavity Detection Algorithm  
        ...
        [TrkPt,SecPt] = convexcavdet(TrkVar,SecVar);
         [NormalizedValueNew,NumSplo,AvgNumEleAtPeak] = modifiedPeak(TrkPt,NormalizedValue,SecPt,cxxN,cyyN);
...
% set(handles.uipanel4,'enable','on')
%set(handles.uipanel7,'visible','off')
% set(handles.uipanel8,'visible','off')
...
% --- Executes on button press in train_browse_btn.
function train_browse_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_browse_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%Browse Input Image
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
...
% --- Executes on button press in train_cmg_btn.
function train_cmg_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_cmg_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
                      '*.*','All Files' },'Select Input Image',...
...
% --- Executes on button press in train_embd_btn.
function train_embd_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_embd_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
                      '*.*','All Files' },'Select Input Image',...
...
% --- Executes on button press in train_cmrepdes_btn.
function train_cmrepdes_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_cmrepdes_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
                      '*.*','All Files' },'Select Input Image',...
...
% --- Executes on button press in train_fe_btn.
function train_fe_btn_Callback(hObject, eventdata, handles)
% hObject    handle to train_fe_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[fileName,pathName] = uigetfile({'*.jpg;*.tif;*.png;*.gif','All Image Files';...
                      '*.*','All Files' },'Select Input Image',...
...
folder_name = uigetdir;
 ...
 set(handles.edit7,'visible','on');
%pause(10);
% str = extractBetween(folder_name,38,46);
% M = 'benign';
% string3 = sprintf('M = %.3f', M);
